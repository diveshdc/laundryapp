        ...
        foreach ($date_arr as $key => $value) {
            ...
            while ($start_time <= $end_time) // loop between time
            {
                ...
                $savedData = TimeSlot::Insert([
                     ...
                     'collection_time_start'=> date ("h:i:s",$start_time),
                     'collection_time_end'=>date ("h:i:s", $endTime),
                     'delivery_time_start'=>date ("h:i:s",$start_time),
                     'delivery_time_end'=>date ("h:i:s", $endTime),
