...
<body>
	<p style="text-align: center;height: 55px;"><img src="<?php echo 'http://3.11.134.243/images/image/spotlex_logo.png'; ?>"></p>
		...
		<p>If you did not request your password change, please contact our help team as soon as possible on (info@spotlex.co.uk). Thank you</p> 
		<p>Kind regards</p> 
		<p>Spotlex help team</p> 
		<p>Email: info@spotlex.co.uk</p> 
		<p>Follow us on social media for news and special offers.</p>
