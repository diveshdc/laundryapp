...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('global.new') }} {{ trans('global.driver.title_singular') }}
        </div>
        <div class="card-body">
            <form id="create_driver" action="{{ route('admin.drivers.store') }}" method="POST"
                ...
                <fieldset class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                    ...
                    <span class="input-group-prepend">
                        ...
                        <input type="text" id="first_name" name="first_name" class="form-control"
                               value="{{ old('first_name', isset($user) ? $user->first_name : '') }}"> @if($errors->has('first_name'))
                ...
                <fieldset class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                    ...
                    <span class="input-group-prepend">
                        ...
                        <input type="text" id="last_name" name="last_name" class="form-control"
                               value="{{ old('last_name', isset($user) ? $user->last_name : '') }}"> @if($errors->has('last_name'))
                ...
                <fieldset class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                    ...
                    <span class="input-group-prepend">
                        ...
                        <input type="email" id="email" name="email" onblur="checkEmailIsAlready(this)"
                               class="form-control" value="{{ old('email', isset($user) ? $user->email : '') }}">
                ...
                <fieldset class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                    ...
                    <span class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="phone_number"
                               id="phone_number"> @if($errors->has('phone_number'))
            ...
            <fieldset class="form-group {{ $errors->has('post_code') ? 'has-error' : '' }}">
                ...
                <fieldset class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                    ...
                    <span class="input-group-prepend">
                        ...
                        <input type="password" id="password" name="password"
                               class="form-control"> @if($errors->has('password'))
                ...
                <fieldset class="form-group {{ $errors->has('vehicle_number') ? 'has-error' : '' }}">
                    ...
                    <span class="input-group-prepend">
                        ...
                        <input type="vehicle_number" id="vehicle_number" name="vehicle_number"
                               class="form-control"> @if($errors->has('vehicle_number'))
                    ...
                    <span class="input-group-prepend">
                        ...
                        <select name="roles[]" id="roles" class="form-control">
                            ...
                            @foreach($roles as $id => $roles)
                                <option
                                    value="{{ $id }}" {{ (in_array($id, old('roles', [])) || isset($user) && $user->roles->contains($id)) ? 'selected' : '' }}> {{ $roles }}
                                </option>
                            @endforeach
